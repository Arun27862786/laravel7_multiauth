...
<p class="center">Space Invadors destroyed this page! Take revenge on them!
  ...
  <button> <a onclick="history.back(-1)" class="btn btn-default btn-xs">Go Back</a></button>
  <button><a href="{{ url('/home') }}" class="btn btn-default btn-xs" style=" ">Go to Home Page</a></button></p>
